...
```{r}
aux_train <- select(train, RATE_PLAN, HANDSET_NAME, VALUE_SEGMENT, GENDER)
aux_test <- select(test, RATE_PLAN, HANDSET_NAME, VALUE_SEGMENT, GENDER)
train <- select(train, -RATE_PLAN, -HANDSET_NAME, -VALUE_SEGMENT, -GENDER)
test <- select(test, -RATE_PLAN, -HANDSET_NAME, -VALUE_SEGMENT, -GENDER)
...
rm(preProc)
train <- cbind(train, aux_train)
test <- cbind(test, aux_test)
rm(aux_train, aux_test)
```
