...
```{r}
monthly$X206_SESSION_COUNT[monthly$X206_SESSION_COUNT > session_count_threshold] <- session_count_threshold
monthly$X207_SESSION_COUNT[monthly$X207_SESSION_COUNT > session_count_threshold] <- session_count_threshold
monthly$X208_SESSION_COUNT[monthly$X208_SESSION_COUNT > session_count_threshold] <- session_count_threshold
monthly$X209_SESSION_COUNT[monthly$X209_SESSION_COUNT > session_count_threshold] <- session_count_threshold
monthly$X210_SESSION_COUNT[monthly$X210_SESSION_COUNT > session_count_threshold] <- session_count_threshold
```
...
```{r}
monthly$X206_USAGE[monthly$X206_USAGE > usage_threshold] <- usage_threshold
monthly$X207_USAGE[monthly$X207_USAGE > usage_threshold] <- usage_threshold
monthly$X208_USAGE[monthly$X208_USAGE > usage_threshold] <- usage_threshold
monthly$X209_USAGE[monthly$X209_USAGE > usage_threshold] <- usage_threshold
monthly$X210_USAGE[monthly$X210_USAGE > usage_threshold] <- usage_threshold
```
...
roaming_data <- merge(roaming_usage, roaming_sessions)
rm(roaming_usage, roaming_sessions)
```

# Train: Monthly * Contracts
...
daily_aggr <- merge(daily_usage, daily_sessions)
```
